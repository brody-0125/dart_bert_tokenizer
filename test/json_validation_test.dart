...
void main() {
  final invalid = <String, void Function(Map<String, dynamic>)>{
    ...
    'added-token single word': (j) =>
        j['added_tokens'][0]['single_word'] = true,
    'added-token lstrip': (j) => j['added_tokens'][0]['lstrip'] = true,
    'added-token rstrip': (j) => j['added_tokens'][0]['rstrip'] = true,
